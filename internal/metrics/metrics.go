...
func NewESMicroserviceMetrics() *ESMicroserviceMetrics {
	return &ESMicroserviceMetrics{
		...
		ChangeAddressOrderGrpcRequests: promauto.NewCounter(prometheus.CounterOpts{
			Name: fmt.Sprintf("%s_change_address_order_gRPC_requests_total", global.Config.ServiceName.ServiceName),
		...
		ChangeAddressOrderHttpRequests: promauto.NewCounter(prometheus.CounterOpts{
			Name: fmt.Sprintf("%s_change_address_order_http_requests_total", global.Config.ServiceName.ServiceName),
